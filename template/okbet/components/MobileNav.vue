...
import { useNaviagtionBarListCms } from "src/common/apiHooks/cms/useNaviagtionBarListCms"
...
const { navigationBarList } = useNaviagtionBarListCms()
...
:deep(.nav-tabs) {
  ...
  .q-tab {
    @apply rounded-lg min-w-[auto] p-0 shrink-0;

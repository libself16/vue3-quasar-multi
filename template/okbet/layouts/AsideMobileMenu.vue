<template>
  ...
  <div class="mobile-side-menu" :class="{ isOpen: modelValue }">
    ...
    <div class="logo">
      <div class="mobile-logo-image-container">
    ...
    <div class="button-area button-area-bottom">
      ...
      >
        ...
        <template #default>
          <ul class="account-list">
            ...
            <q-btn
              v-if="userInfo2.is_member_agent"
              @click="setActiveItem('account', 'membershipManagement')"
              class="normal-btn account-inner-title"
              align="left"
              :to="{ name: 'MembershipManagement' }"
            >
              <span
                class="btn-title"
                :class="{
                  'btn-title-active': activeItem.type === 'account' && activeItem.id === 'membershipManagement'
                }"
              >
      ...
      <q-btn
        v-for="(cmsItem, cmsIndex) in asideMenuBtnList"
        :key="cmsIndex"
...
import HomeBanner from "app/template/okbet/components/Banner/HomeBanner.vue"
...
import { useAsideMenuBtnListCms } from "src/common/apiHooks/cms/useAsideMenuBtnListCms"
// import { useGame } from "src/common/composables/useGame"
import { useLanguage } from "src/common/composables/useLanguage"
import { useLogo } from "src/common/composables/useLogo"
import { useUserInfo } from "src/common/composables/useUserInfo"
import { useAuth } from "src/common/hooks/useAuth"
import { CMS_TYPE, LANGUAGE_TYPE, HISTORY_SEARCH_TYPE } from "src/common/utils/constants"
...
// useAsideMenuBtnListCms 取代 useCms 取得側邊選單 CMS 列表
const { asideMenuBtnList } = useAsideMenuBtnListCms()
...
const { addListeners, removeListeners, registerNotifications } = useNotification()
const { isCash } = useEnv()
...
.mobile-side-menu
  ...
  .logo
    ...
    :deep(.q-focus-helper)
      opacity: 0 !important
    .mobile-logo-image-container
      width: calc(100% - 6.625rem)
    .mobile-logo-image
      @apply h-[3.4375rem] max-w-full object-contain
    .btn-area
      width: auto
      +setFlex
      position: absolute

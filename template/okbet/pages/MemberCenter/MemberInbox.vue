<template>
  <HeaderTitleBack v-if="isMobile" title-i18n="member.mail.messageCenter">
  ...
  <!-- dialog -->
  <q-dialog v-model="modalShow" @hide="initMailDetail" :persistent="!isMobile">
    <q-card v-if="isMobile" class="dialog h5">
...
import { QScrollAreaProps, QTableProps } from "quasar"
...
.dialog.h5 {
  ...
  margin: 0px;
  background: url("app/template/okbet/assets/images/member/mail-h5-bg.png") left top / cover no-repeat

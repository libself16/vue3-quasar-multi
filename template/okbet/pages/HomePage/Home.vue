<template>
  <div class="w-full" :class="{ 'px-6': !isMobile }">
    <HomeBanner />
  </div>
  ...
  <div class="home-layout">
    ...
    <div class="home-content" id="scrollDom" @scroll="handleInnerScroll()">
      <div class="home-content-cms px-6 phone:px-4" v-if="homeList && homeList?.length">
        <div v-for="(cmsItem, cmsIndex) in homeList" :key="cmsIndex" class="game-show-area">
...
import BaseImage from "src/common/components/BaseImage/index.vue"
...
import { useHomeListCms } from "src/common/apiHooks/cms/useHomeListCms"
...
.game-list
  ...
  ::v-deep(.carousel__prev)
    ...
    text-indent: -100px
    overflow: hidden
    background: rgba($background-dusty-blue-light-color, 0.6)

<template>
  ...
  <div class="w-full px-6 phone:px-4">
    <div class="provider-container" :class="`${isMobile ? 'h5' : 'pc'}`">
      ...
      <ProviderList @handle-tab-click="handleTabClick" />
    </div>
  </div>
          ...
          <div class="img-container">
            ...
            <div :class="cx('favorite-container', { 'pr-2': game.favorite_count > 0 })">
              <div class="favorite-icon-container">
                ...
                <div v-else class="btn-favorite-icon btn-favorite-unactive" @click.stop="addfavoriteGame(game, true)">
...
const { isDown, width } = useMediaQuery()

...
function changeDialog(status: boolean) {
  console.log("changeDialog", status)
...
.h5 {
  ...
  .form-container {
    ...
    :deep(.q-field__bottom) {
      color: $functional-line !important;
    }
  }
  .btn-submit {
    @apply h-[3.0625rem] w-full mt-[.6875rem] rounded-[.5rem] text-center;
    font-family: inherit;
    font-size: 1.1026rem;
    background: $primary-01;
    color: $functional-btn-text-primary;
  ...
  .form-bottom {
    ...
    color: $neutral-01;
    border-radius: 16px;
    border: 0.5px solid $functional-line;

<template>
  <HeaderTitleBack titleI18n="ai.agent" variant="blueOrange">
    ...
    <div class="condition-card-container">
      ...
      <MockGameFirst data-theme="set_r024" />
      <MockGameSecond data-theme="set_r024" />
      <MockGameThird data-theme="set_r024" />
    </div>
    <FooterNav />
...
@import "app/template/set_r024/assets/css/agent.scss";

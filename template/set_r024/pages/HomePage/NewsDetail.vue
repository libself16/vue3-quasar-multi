<template>
  ...
  <HeaderTitleBack titleI18n="menu.newsDetails" variant="blueOrange" v-else>
...
.news-detail-bg
  background:  url("app/template/set_r024/assets/images/news/newsbg.png") no-repeat
.bottom-content-area
    ...
    .news-detail-wrap
      ...
      .detailWrap
        ...
        .title-wrap
          ...
          z-index: 1
          padding: 24px
          background: linear-gradient(0deg, $background-ocean-depths-color 0%, rgba($background-dark-color, 0) 118.89%)
          display: flex
...
.news-detail-area-mobile
  ...
  .divide
    width: 100%
    margin: 10px 0px
    border-color: $border-pale-gray-color
    align-items: center
    border-style: solid
    border-width: 0
    color: $text-balanced-gray-color
    display: flex
    font-size: 14px

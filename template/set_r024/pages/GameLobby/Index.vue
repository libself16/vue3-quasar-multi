<template>
  <div :class="cx('w-full', PAGE_X_SPACING, FLEX_CENTER)">
    <GameBanner :isNeedMaxWidth="isNeedMaxWidth" />
  </div>
  ...
  <div class="w-full px-6 phone:px-4">
    <div class="provider-container" :class="`${isMobile ? 'h5' : 'pc'}`">
      ...
      <swiper :slides-per-view="isMobile ? 2.5 : 4.3" :space-between="10">
        ...
        >
          <img
            :src="getProductTabImage({ ...product, siteKey: 'set_r024' })"
            class="tab-img"
...
import GameBanner from "app/template/set_r024/components/Banner/GameBanner.vue"
import RankBoard from "app/template/set_r024/components/Carousel/RankBoard.vue"
import FooterArea from "app/template/set_r024/components/Footer/Index.vue"
import MobileNav from "app/template/set_r024/components/MobileNav.vue"
...
@import "app/template/set_r024/assets/css/game.scss";
@import "app/template/set_r024/assets/css/button.scss";
@import "app/template/set_r024/assets/css/data.scss";
  ...
  &.pc {
    ...
    .swiper {
      ...
      .swiper-slide {
        ...
        @apply w-[16.25rem] h-[6.25rem] rounded-[.75rem];

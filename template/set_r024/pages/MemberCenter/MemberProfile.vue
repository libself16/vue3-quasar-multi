<template>
  <template v-if="$q.platform.is.mobile">
    <HeaderTitleBack title-i18n="menu.memberCenter" qCardClass="!overflow-y-hidden" variant="blueOrange">
...
import FooterNav from "app/template/set_r024/components/Footer/FooterNav.vue"
...
@import "app/template/set_r024/assets/css/member.scss";
...
.member-layout-h5 {
  @apply fixed top-[5.625rem] right-0 bottom-0 left-0 overflow-auto;
  z-index: 1000;
  height: 100%;
  background: url("app/template/set_r024/assets/images/member/h5-bg.png") center / contain no-repeat;
...
.profile-h5 {
  ...
  .wallet-header {
    @apply flex items-center justify-between flex-nowrap flex-row h-20;

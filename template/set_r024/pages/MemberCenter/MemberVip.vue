...
import VipH5Dialog from "app/template/set_r024/components/VipH5Dialog.vue"
...
.pc-vip-container {
  .vip-content {
    @apply w-full h-full overflow-x-hidden px-[3.125rem] py-[2.5rem];
    color: $neutral-01;
    .header {
  ...
  .benefits-content {
    ...
    .benefits-single-currency {
      @apply flex flex-col gap-4 rounded-[1.5rem];
    ...
    @include iphone-width {
      ...
      .h5-main-content {
        ...
        .h5-vip-swiper {
          ...
          :deep(.swiper-button-next),
          :deep(.swiper-button-prev) {
            @apply w-[1.75rem] h-[1.75rem] rounded-full;
            background: $secondary-card-light;
            color: $neutral-01;

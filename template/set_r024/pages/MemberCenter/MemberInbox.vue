<template>
  <HeaderTitleBack v-if="$q.platform.is.mobile" title-i18n="member.mail.messageCenter" variant="blueOrange">
    ...
    >
      ...
      <template #body="props">
        <q-tr>
          ...
          <q-td key="mail_body" :props="props" class="underline underline-offset-4">
...
.inbox-container.h5 {
  ...
  .q-tab-panel {
    ...
    .q-scrollarea {
      ...
      .footer {
        @apply flex items-center justify-center px-0 py-3 opacity-50;
        color: $neutral-01;

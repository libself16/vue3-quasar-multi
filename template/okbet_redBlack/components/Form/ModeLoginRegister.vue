        ...
        <div class="terms-container">
          <div class="term-row">
            <span>
              ...
              <router-link :to="{ name: 'PrivacyPolicy' }" target="_blank" class="text-secondary">
          ...
          <div class="term-row">
            <span>
              ...
              <router-link :to="{ name: 'TermAndCondition' }" target="_blank" class="text-secondary">
...
.pc {
  ...
  .form-bottom {
    ...
    .terms-container {
      ...
      .term-row {
        color: $login-register-primary-text-color;

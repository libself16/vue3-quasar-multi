  ...
  >
    <q-form class="bank-add-layout h5" :class="{ '!pb-[24rem]': isTelegramMiniApp }" @submit="handleSubmit">
      ...
      <div class="action-btns row justify-center">
        <q-btn text-color="black" color="primary" :label="$t('common.btn.confirm')" class="submit-btn" type="submit" />
      </div>
    </q-form>
  </HeaderTitleBack>
        ...
        <div class="profile-form column">
          ...
          <q-form class="form-content" @submit="handleSubmit">
            ...
            <div class="action-btns multi-btns row justify-center no-wrap">
              <q-btn outline color="white" :label="$t('common.btn.cancel')" class="cancle-btn" @click="goMemberBank" />
              <q-btn
                text-color="black"
...
.radio-content
  ...
  ::v-deep(.q-radio)
    .q-radio__inner
      ...
      border-color: $primary-red02 !important

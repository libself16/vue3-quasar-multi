  ...
  <div class="w-full px-6 phone:px-4">
    <div class="provider-container" :class="`${isMobile ? 'h5' : 'pc'}`">
      ...
      <swiper :slides-per-view="isMobile ? 2.5 : 4.3" :space-between="10">
        ...
        >
          <img
            :src="getProductTabImage({ ...product, siteKey: 'okbet_redBlack' })"
            class="tab-img"
...
import GameBanner from "app/template/okbet_redBlack/components/Banner/GameBanner.vue"
import RankBoard from "app/template/okbet_redBlack/components/Carousel/RankBoard.vue"
import FooterArea from "app/template/okbet_redBlack/components/Footer/Index.vue"
import MobileNav from "app/template/okbet_redBlack/components/MobileNav.vue"
...
import { FLEX_CENTER, PAGE_X_SPACING } from "app/src/common/utils/constants/styles"
...
@import "app/template/okbet_redBlack/assets/css/game.scss";
@import "app/template/okbet_redBlack/assets/css/button.scss";
@import "app/template/okbet_redBlack/assets/css/data.scss";

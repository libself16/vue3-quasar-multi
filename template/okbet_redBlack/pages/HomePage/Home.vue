<template>
  ...
  <div class="home-layout">
    ...
    <div class="home-content" id="scrollDom" @scroll="handleInnerScroll()">
      ...
      <!-- 最新得獎跑馬燈 -->
      <div :class="cx('w-full', FLEX_JUSTIFY_CENTER, 'px-4 phone:px-2')">
...
import HomeBanner from "app/template/okbet_redBlack/components/Banner/HomeBanner.vue"
    ...
    .download-main
      ...
      .article
        ...
        h1
          ...
          margin-bottom: 10px
        h5
          @apply text-[1.5rem] phone:text-xl iphone:text-lg leading-none font-bold
          font-family: "OpenSans"
          color: $text-night-sky-color
        p

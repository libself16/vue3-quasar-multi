<template>
  ...
  <div class="product-container">
    <ul class="product-row">
      ...
      >
        <img
          :src="getPorductImg(gameTypeId, product.product_code)"
...
const { getPorductImg, setDefaultProductImg } = useCommonImg()
  ...
  .product-row
    ...
    .product-item
      ...
      .btn-play
        ...
        background: linear-gradient(to bottom, rgb(149, 197, 65) 0%, rgb(103, 163, 60) 100%)
        text-shadow: 1px 1px 2px rgba(0, 0, 0, .5098039216)

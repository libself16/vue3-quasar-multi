...
.btn-common-active
  ...
  box-shadow: 0px 0px 10px 0px #0A9005B2
  text-shadow: 0px 0px 14px $primany-01
  color: $primany-02
  span
    color: $functional-btn-text-primany
    text-shadow: 0px 0px 14px 0px $primany-01
    ...
    div
      ...
      &.join-btn
        ...
        +iphone-width
          ...
          +setFlex
        &:hover
          background: linear-gradient(0deg, rgba($background-side, 0.20) 0%, rgba($background-side, 0.20) 100%), $yellow-active
        span

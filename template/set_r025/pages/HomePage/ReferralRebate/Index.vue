                ...
                <div class="actions">
                  <div class="date-action">
                    <div class="date-select">
                      ...
                      <q-input v-model="displayDate" placeholder="" outlined readonly dense class="w-full md:w-auto">
                        <template v-slot:append>
                          <q-icon name="event" class="cursor-pointer">
                            <q-popup-proxy cover transition-show="scale" transition-hide="scale">
                              <q-date range v-model="selectedDate" mask="YYYY-MM-DD" color="primary">
...
@import "app/template/set_r025/assets/css/referral-rebate.scss";

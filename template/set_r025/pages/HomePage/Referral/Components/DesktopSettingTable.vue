...
import Pagination from "app/template/set_r025/components/Pagination/Index.vue"
...
@import "app/template/set_r025/assets/css/referral.scss";
...
.dialog-card {
  ...
  .btn-wrapper {
    ...
    .cancel-btn,
    .confirm-btn {
      @apply text-[1.25rem] h-[43px] w-[10.5rem] capitalize;

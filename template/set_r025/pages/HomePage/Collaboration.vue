<template>
  <div class="collaboration">
    <div class="collaboration-content">
      <img :src="collaborationState.banner" alt="" class="w-full" />
                      ...
                      <template v-slot:append>
                        <q-icon name="event" class="cursor-pointer">
                          <q-popup-proxy cover transition-show="scale" transition-hide="scale">
                            <q-date class="date-picker" range color="primary" v-model="selectedDate" mask="YYYY-MM-DD">
...
@import "app/template/set_r025/assets/css/collaboration.scss";
</style>

<template>
    ...
    <div class="h5-order-container">
      <q-form @submit="handleSubmit">
        ...
        <div class="date-picker-container">
          ...
          <q-btn color="primary" type="submit" class="btn-submit">{{ $t("common.btn.search") }}</q-btn>
        </div>
  ...
  <div v-else class="pc-order-container">
    <q-form @submit="handleSubmit" @reset="handleReset">
      <div class="text-[3.125rem] font-extrabold">Pending Status</div>
      <!-- 類型切換 -->
      <q-tabs
...
/* Firefox 滚动条样式 */
.custom-scroll-container {
  scrollbar-color: $primany-01 $neutral-04;

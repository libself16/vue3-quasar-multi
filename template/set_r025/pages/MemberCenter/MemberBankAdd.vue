  ...
  >
    <q-form class="bank-add-layout h5" :class="{ '!pb-[24rem]': isTelegramMiniApp }" @submit="handleSubmit">
      ...
      <div class="action-btns row justify-center">
        <q-btn text-color="white" color="primary" class="submit-btn" type="submit">
  ...
  <div v-else class="bank-add-layout pc">
    <div class="bank-add-container">
      <div class="bank-header">
        <div class="text-[3.125rem] font-extrabold">Bank Detail</div>
      </div>
        ...
        <div class="profile-form column">
          ...
          <q-form class="form-content" @submit="handleSubmit">
            ...
            <div class="action-btns multi-btns row justify-center no-wrap">
              ...
              <q-btn text-color="black" color="primary" class="submit-btn" type="submit">
                {{ $t("common.btn.confirm") }}
              </q-btn>
            </div>
          </q-form>
...
.radio-content
  ...
  ::v-deep(.q-radio)
    .q-radio__inner
      ...
      background-color: $secondary-card !important
      border-color: $primany-01 !important

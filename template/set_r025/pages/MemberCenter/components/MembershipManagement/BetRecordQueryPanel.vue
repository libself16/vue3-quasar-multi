    ...
    <template #top>
      <q-form @submit.prevent="memberManagementStore.handlerSearchBetRecordQuery" class="search-form">
        ...
        <div class="search-form-row">
          ...
          <div class="search-item bet-record-report">
            <q-checkbox v-model="memberManagementStore.settlementDate" color="primary" size="xs" />
            {{ $t("menu.settlementDate") }}
          </div>

          <div class="search-item bet-record-report">
            <q-checkbox v-model="memberManagementStore.betDate" color="primary" size="xs" />
            {{ $t("member.membershipManagement.betDate") }}
          </div>

          <q-btn :label="$t('common.btn.search')" unelevated class="search-btn bet-record-report" type="submit" />
        </div>
      </q-form>
    </template>

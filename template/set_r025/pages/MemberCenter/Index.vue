        ...
        <div class="member-info">
          ...
          <div class="info-row">
            <span class="info-row-left">
              <q-icon name="fa-regular fa-user" size="sm" color="neutral-01" class="p-1"></q-icon>
              <span class="label">{{ userInfo2.nickname || userInfo2.fullname }}</span>
            </span>
          </div>
          <div class="info-row">
            <span class="info-row-left">
              <q-icon name="las la-wallet" size="md" color="neutral-01"></q-icon>
      ...
      .member-left {
        ...
        .menu-item {
          ...
          &:hover {
            ...
            border-right: 1px solid $functional-line;

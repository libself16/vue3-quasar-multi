<template>
  ...
  <VipH5Dialog v-else title-i18n="vip.vipRewards" class="h5-vip-container" :isBgBlack="true" :isShowLineCover="false">
    <template #header>
      <div class="h5-header">
...
import VipH5Dialog from "src/common/components/set_r025/VipH5Dialog.vue"
  ...
  .main-content {
    .vip-swiper {
      ...
      :deep(.swiper-button-disabled) {
        color: $secondary-btn-disabled;
        background: $functional-btn-text-disabled;
      }
    }
  }
  ...
  .benefits-content {
    ...
    .benefits-multi-currency {
      ...
      .benefits-multi-content {
        width: 26.1875rem;
        h3 {
          @apply text-[1.3rem] phone:text-base leading-[1.2];
          font-family: OpenSans;
          font-weight: 600;
          color: $neutral-01;
        }
...
.h5-vip-container {
  ...
  .h5-benefits-content {
    ...
    .h5-benefits {
      ...
      .h5-benefit-card {
        @apply pl-[2.4rem] md:pl-[3.1875rem] pr-4;
        @apply flex flex-col gap-2 md:gap-4;
        @apply rounded-xl w-full min-h-[13rem];
        background: $secondary-card-secondary;
      }
    }

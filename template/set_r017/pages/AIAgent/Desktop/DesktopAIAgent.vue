...
const { aiAgentDesktopTitleImg } = useSiteImg()
...
.desktop-agent-container {
  @apply flex flex-col max-w-[75rem] mx-auto py-[2.5rem];
}
...
.setting-input-item {
  @apply flex flex-col w-[18.75rem] gap-[.25rem];
  color: $neutral01;

  .setting-input-tips {
    @apply font-bold text-[.875rem];
    color: $emotional03;
  }
}

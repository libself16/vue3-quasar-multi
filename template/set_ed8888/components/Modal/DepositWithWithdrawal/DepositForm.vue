      ...
      <div class="form-row field-input flex flex-col pay-area" v-if="depositState.paymentDetail.extra_field_key">
        ...
        >
          ...
          <ExtraSelect
            ...
            :field="field"
            class="form-input"
            popup-content-style="background-color: #7c0000; color: rgb(255, 255, 255);"
          ></ExtraSelect>
          <!-- 其他 -->
          <ExtraInput
            v-else
...
const updateInputDisplay = () => {
  ...
  console.log(depositState.form.amount)
}
...
.quick-btn-wrapper {
  @apply flex flex-wrap gap-[.5rem] max-h-[2.5rem] mb-[3.125rem];

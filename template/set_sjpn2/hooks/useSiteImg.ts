...
export function useSiteImg() {
  ...
  function getSiteProductImg(gameTypeId: number, productCode: number): string {
    ...
    return `${VITE_APP_STATIC_RESOURCE_URL}/images/products/set_sjpn2/${gameType}/${productCode}.png`
  }
  function getSiteProductTabImg(productCode: number): string {
    return `${VITE_APP_STATIC_RESOURCE_URL}/images/tabs/set_sjpn2/${productCode}.png`
  }

        ...
        <div class="summary">
          <div class="summary-content">
            <div class="summary-title">
              {{
                referralRebateSummary.calculate_type === CALCULATE_TYPE.Enums.ValidBet
                  ? $t(CALCULATE_TYPE.I18nKeys[CALCULATE_TYPE.Enums.ValidBet])
                  : $t(CALCULATE_TYPE.I18nKeys[CALCULATE_TYPE.Enums.WinLose])
              }}
            </div>
            <div class="summary-value">
              {{
                referralRebateSummary.calculate_type === CALCULATE_TYPE.Enums.ValidBet
                  ? moneyFormat(referralRebateSummary?.valid_bet_amount)
                  : moneyFormat(referralRebateSummary?.profit)
              }}
            </div>
          </div>
          <div class="summary-content">
                    ...
                    <div class="date-select">
                      ...
                      <q-dialog v-model="isShowDatePicker" position="standard">
                        <q-card class="q-pa-none">
                          <q-date range v-model="selectedDate" class="calendar-content w-full" mask="YYYY-MM-DD">
...
// 開發測試用：設置為 true 使用假資料，false 使用真實 API

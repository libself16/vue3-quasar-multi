    ...
    <q-form @submit="handleWithdralSubmit()">
      ...
      <div class="balance-wrapper">
        <div class="field-input flex flex-col gap-[10px] pt-[10px]">
          ...
          <q-input v-model.trim="withdrawState.form.balance" class="form-input" outlined :disable="true">
        ...
        <div class="field-input flex flex-col gap-[10px] pt-[10px]">
          ...
          <q-input v-model.trim="withdrawState.form.remaining_turnover" class="form-input" outlined :disable="true">
            <template v-slot:prepend>

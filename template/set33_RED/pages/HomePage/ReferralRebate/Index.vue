        ...
        <div class="summary">
          <div class="summary-content">
            <div class="summary-title">
              {{
                returnReferralRebateSummary.calculate_type === CALCULATE_TYPE.Enums.ValidBet
...
import banner from "app/template/set33_RED/assets/images/referral_rebate/bg.jpg"

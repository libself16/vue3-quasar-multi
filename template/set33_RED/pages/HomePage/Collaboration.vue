<template>
  <div class="collaboration">
    <div class="collaboration-content">
      <q-img v-if="collaborationState.banner" width="100%" :src="collaborationState.banner" alt="" />
      <div class="title text-nowrap">
        <span>{{ $t("collaboration.title") }}</span>
      ...
      <div class="summary-wrapper">
        ...
        <div class="referral-code">
          <div class="referral-code-title text-white">{{ $t("collaboration.exclusive_referral_code") }}</div>
      ...
      <div>
        ...
        <div class="proxy-tabs">
          <q-tabs v-model="activeTab" align="left">
            <q-tab content-class="text-wrap" name="invitationDetails" :label="$t('collaboration.invitation_details')" />
            <q-tab content-class="text-wrap" name="commissionDetails" :label="$t('collaboration.commission_details')" />
          </q-tabs>
        </div>
        <!-- Search content -->
                ...
                <div class="date-action">
                  <div class="date-select">
                    ...
                    <q-input
                      ...
                      readonly
                      dense
                      class="w-full text-white date-select-input"
                    >
                      <template v-slot:append>
                        <q-icon name="event" class="cursor-pointer">
                          <q-popup-proxy cover transition-show="scale" transition-hide="scale">
                            <q-date class="text-white bg-[#3D0202]" range v-model="selectedDate" mask="YYYY/MM/DD">
                    ...
                    <q-card class="w-full">
                      ...
                      <q-slide-transition v-show="props.row.showDetail">
                        <div class="p-4 card_detail">
                          <template v-for="col in props.cols" :key="col.name">
                            <div
                              v-if="!['settled_time', 'active_member_count'].includes(col.name)"
                              class="row-item mb-2"
                            >
                              <div class="label">
                                {{ col.label }}
    ...
    <q-dialog v-model="showTip" persistent>
      <q-card class="rule-dialog">
        <q-card-section class="row items-center q-pb-none pl-6">
          <div class="text-h6 text-white">{{ collaborationState.title }}</div>
          <q-space />
...
@import "app/template/set33_RED/assets/css/collaboration.scss";
</style>

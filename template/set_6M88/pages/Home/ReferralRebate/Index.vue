          ...
          >
            <template v-slot:append>
              <q-icon
                ...
                class="cursor-pointer mr-1 hover:opacity-50 text-[#00546E]"
                size="xs"
              ></q-icon>
              <q-icon
                name="content_copy"
                class="cursor-pointer hover:opacity-50 text-[#00546E]"
                size="xs"
                    ...
                    <template v-slot:body="props">
                      <tr>
                        <td v-for="col in referralRebateStatementsTableColumns" :key="col.name">
                          <span v-if="col.field === 'game_type'">{{ $t(props.row[col.field]) }}</span>
            ...
            <q-tab-panel name="revenueDetail">
              <div class="table-content">
                ...
                <div class="actions">
                        ...
                        <template v-slot:append>
                          <q-icon name="event" class="cursor-pointer">
                            <q-popup-proxy cover transition-show="scale" transition-hide="scale">
                              <q-date range v-model="selectedDate" mask="YYYY-MM-DD">
                  ...
                  <div class="currency-action mb-4">
                    <div class="currency-select">
                      <span class="currency-select-title">{{ $t("common.btn.currency") }}</span>
                      <q-btn-dropdown
                        rounded
...
@import "app/template/set_6M88/assets/css/referral-rebate.scss";
</style>
...
import banner from "app/template/set_6M88/assets/images/referral_rebate/bg.jpg"
...
const {
  ...
  handleDetailClick,
  tableRowClass,
  mockReferralRebateStatements,
  mockReferralRebateEvents,
  mockReferralRebateEventsStatements
} = useReferralRebate()

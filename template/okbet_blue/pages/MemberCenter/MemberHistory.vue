<template>
    ...
    <div class="h5-history-container">
      <q-form @submit="handleSubmit">
        <div class="date-picker-container">
          ...
          <BasePrimaryBtn type="submit" class="btn-submit">{{ $t("common.btn.search") }}</BasePrimaryBtn>
        </div>
          ...
          <q-scroll-area v-if="historyState.list.length" @scroll="handleScroll" :visible="false" ref="scrollAreaRef">
            ...
            >
              ...
              <q-card>
                ...
                <q-card-section v-if="history.wager_code">
                  <span class="title">{{ $t("tableHeader.betNumber") }}</span>
                  <span class="text"> {{ history.wager_code }} </span>
                </q-card-section>
                <q-card-section>
  ...
  <div v-else class="pc-history-container">
    <q-form @submit="handleSubmit" @reset="handleReset">
      <p class="history-title">{{ $t("menu.history") }}</p>
      <!-- 類型切換 -->
      ...
      >
        ...
        <template #body="props">
          <q-tr>
            <q-td class="custom-td" key="timeNumber" :props="props" width="5%">
            ...
            <q-td class="custom-td" key="accountVariableObject" :props="props">
              ...
              <span class="text-transaction-code">{{ `${props.row.transaction_code}` }}</span>
            </q-td>
...
import BasePrimaryBtn from "app/template/okbet_blue/components/BasePrimaryBtn/index.vue"
import BasePrimaryOutlineBtn from "app/template/okbet_blue/components/BasePrimaryOutlineBtn/index.vue"
...
@import "app/template/okbet_blue/assets/css/reports.scss";

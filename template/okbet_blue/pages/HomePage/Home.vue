  ...
  .download-area
    ...
    .download-main
      ...
      .article
        ...
        h5
          @apply text-[1.5rem] phone:text-xl iphone:text-lg leading-none font-bold capitalize
        p
          @apply text-base phone:text-sm iphone:text-xs leading-[1.5] font-normal capitalize
          @apply mt-[.8125rem]

        ...
        <q-td key="actions" :props="props">
          <template v-if="isCredit">
            <span
              ...
              :key="index"
              class="text-[#1FAB3D] cursor-pointer"
              :class="{ 'mr-4': !index }"
              @click="
          ...
          <span
            ...
            class="text-[#1FAB3D] cursor-pointer ml-4"
            @click="
              memberManagementStore.handlerClickOperation(
                props.row.member_account,
                props.row.member_id,
  ...
  <div v-else class="expansion-menu">
    ...
    <q-list v-if="memberManagementStore.manageRows?.length">
      ...
      >
        ...
        <q-card>
          <q-card-section class="!bg-[#E7F8E9] !p-5">
...
@import "app/template/okbet_green/assets/css/membershipManagement.scss";
</style>

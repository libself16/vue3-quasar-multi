<template>
  <HeaderTitleBack v-if="$q.platform.is.mobile" titleI18n="member.kyc.kyc_verify" variant="green-member">
    <div class="profile-container h5" v-if="step === 1" style="margin-top: 10px">
            ...
            <div class="content">
              <div class="contentText">
                <div class="columnContent">
                  <p>Please take a photo holding a valid ID for quick verification.</p>
                  <p>All information on the ID must be complete and clear for identification.</p>
                </div>
              </div>
      ...
      <div class="btn-submit-container">
        <q-btn unelevated color="primary" type="submit" @click="goStep(2)">{{ $t("common.btn.startNow") }}</q-btn>
      </div>
    </div>
    ...
    <div class="profile-container h5" v-else-if="step === 3">
      <div class="result">
        <div class="result_content">
          ...
          <p>Thank you for verifying with us. For faster processing, please contact our customer support team.</p>
        </div>
      </div>
    </div>
  </HeaderTitleBack>
      ...
      <div class="card">
        ...
        <div class="contentWrap">
          <div class="left">
            ...
            <div class="detail">
              <div class="columnTip">
                <span>Please take a photo holding a valid ID for quick verification.</span>
                <span>All information on the ID must be complete and clear for identification.</span>
              </div>
            </div>
          </div>
          <img
...
const { t } = useI18n()
const $q = useQuasar()
const { userInfo2, setUserKyc, isKycEnabled } = useUserInfo()
...
const updateListImgUrl = (value: string, index: number) => {
  ...
  //如果是最後一張圖上傳再開啟下一個
  if (formData.imgs.length < 3 && imgData.id == -1 && value.includes("base64,")) {
    imgData.id = 0
    formData.imgs.push({
      id: -1,
      member_id: 0,

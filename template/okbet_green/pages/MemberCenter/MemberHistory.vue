      ...
      <q-form @submit="handleSubmit">
        <div class="date-picker-container">
          ...
          <q-btn-toggle
            ...
            class="toggle-date-picker min-h-[2.75rem] font"
            :options="dayTypeTabs"
          />
...
.h5-history-container {
  ...
  .toggle-date-picker {
    @apply border border-solid border-gray-300 rounded-lg text-base min-h-[2.75rem] my-4;

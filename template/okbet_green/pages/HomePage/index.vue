<template>
  ...
  <KycUploadDialog color="green" />
  <KycResultDialog
    color="green"
    custom-success-msg="Thank you for verifying with us. For faster processing, please contact our customer support team."
  />
  <!-- <GoogleToptDialog /> -->
</template>

<script lang="ts" setup>
import RegisterPromotionTipDialog from "app/template/okbet_green/components/Dialog/RegisterPromotionTip.vue"
...
const MemberInfoDialog = defineAsyncComponent(
  () => import("app/template/okbet_green/components/Dialog/MemberInfoDialog.vue")
)

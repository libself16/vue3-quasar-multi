  ...
  <div class="w-full px-6 phone:px-4">
    <div class="provider-container" :class="`${isMobile ? 'h5' : 'pc'}`">
      ...
      <swiper :slides-per-view="isMobile ? 2.5 : 4.3" :space-between="10">
        ...
        >
          <img
            :src="getProductTabImage({ ...product, siteKey: 'okbet_green' })"
            class="tab-img"
      ...
      <ul v-if="showGameList.length > 0" class="game-row">
        ...
        >
          <div class="img-container">
            <img
              v-lazy-load="getGameImage(game)"
              :key="`game-${game.game_id}-${game.game_code}`"
              :alt="game.game_code"
              class="game-img"
      ...
      <ul v-if="showGameList.length > 0" class="game-row">
        <li v-for="game in showGameList" :key="game.game_id" class="game-item">
          <div class="img-container">
            <img
              v-lazy-load="getGameImage(game)"
              :key="`game-pc-${game.game_id}-${game.game_code}`"
              :alt="game.game_code"
              class="game-img"
              @error="setDefaultGameImg"
            />
...
@import "app/template/okbet_green/assets/css/data.scss";

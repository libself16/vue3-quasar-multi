<template>
  <div v-if="floatingIconList?.length > 0" class="float-wrapper custom-float-wrapper01">
    <!-- 切換收合 icon -->
    <div @click="toggleShow" class="icon-container">
      <q-img
        v-if="!isLoading"
        :src="isShow ? floatCmsCloseIconBlue01 : floatIconPath"
...
const { floatCmsOpenIconBlue01, floatCmsCloseIconBlue01 } = useSiteImg()
...
const floatIconPath = computed(() => {
  ...
  return matched && matched.storage_key ? matched.storage_key : floatCmsOpenIconBlue01
})

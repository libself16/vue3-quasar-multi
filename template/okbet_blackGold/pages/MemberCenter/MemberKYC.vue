<template>
  <HeaderTitleBack v-if="$q.platform.is.mobile" titleI18n="member.kyc.kyc_verify" variant="blackGold">
    ...
    <div class="profile-header">
      ...
      <div :class="`${FLEX_ITEMS_CENTER} gap-2.5`">
        ...
        <MemberKYCBadgeBtn
          ...
          :approvalStatus="userInfo2.approval_status"
          :shouldNavigate="false"
          @click-action="goStep(1)"
        />
      </div>
    </div>
...
const { t } = useI18n()
const $q = useQuasar()
const { setUserKyc, isKycEnabled, userInfo2 } = useUserInfo()
...
.profile-container.pc {
  ...
  .kyc_upload {
    ...
    .uploadImg {
      ...
      height: 218px;
      padding: 0px 28px;
      border: 1px dashed $primary-gray-color;
      border-radius: 16px;
      margin-top: 27px;
      display: flex;
      -webkit-box-align: center;

<template>
  <div v-if="isReady" class="home-page">
    ...
    <div class="layout-main wide" id="layout-main">
      <div class="hm-content">
        ...
        <div
          class="inner-content scroll"
          :class="{ mobile: isMobile, 'aside-open': isAsideShow }"
    ...
    <div ref="ClaimGiftButton" :style="style" style="position: fixed" class="z-[1000]">
      ...
      >
        <div class="bg-gold-linear-gradient w-[15px] h-[15px] rounded-full ml-auto"></div>
  ...
  <LiveChat />
  <FloatingIconDialog />
  <FloatIconCMS v-draggable="{ storeKey: ELEMENT_KEYS.FLOATICONCMS }" />
</template>

<script lang="ts" setup>
import ClaimGift from "app/template/okbet_blackGold/components/Dialog/ClaimGift.vue"
// import AgeWarningDialog from "app/template/okbet_blackGold/components/Dialog/AgeWarningDialog.vue"
...
import ForgotPasswordDialog from "app/template/okbet_blackGold/components/Dialog/ForgotPassword.vue"
import LoginRegisterDialog from "app/template/okbet_blackGold/components/Dialog/LoginRegister.vue"
import BetDetailDialog from "app/template/okbet_blackGold/components/Dialog/BetDetail.vue"
import HeaderArea from "app/template/okbet_blackGold/components/Header/Index.vue"
import FloatIconCMS from "app/template/okbet_blackGold/components/FloatIconCMS/Index.vue"
import { useSiteImg } from "app/template/okbet_blackGold/hooks/useSiteImg"
import AsideMenu from "app/template/okbet_blackGold/layouts/AsideMenu.vue"
import AsideMobileMenu from "app/template/okbet_blackGold/layouts/AsideMobileMenu.vue"
...
import { useSiteRedirect } from "app/template/okbet_blackGold/composables/useSiteRedirect"
...
const AgeWarningDialog = defineAsyncComponent(
  () => import("app/template/okbet_blackGold/components/Dialog/AgeWarningDialog.vue")
)
...
const { isXLargeTablet } = useMediaQuery()
...
<style>
@import "app/template/okbet_blackGold/assets/fonts/index.css";
...
.layout-main
  ...
  .hm-content
    ...
    .inner-content
      ...
      height: 100%
      overflow-y: auto
      transition: margin-left 0.2s ease 0s, width 0.2s ease 0s
      &::-webkit-scrollbar
        display: none
      &.mobile
        width: 100vw
      ...
      .page-layout
        ...
        @apply pt-20 phone:pt-[3.5625rem]
        &.AboutUs
          padding: 0
...
.reset-btn
  ...
  :deep(.q-focus-helper)
    opacity: 0 !important
.btn-live-chat
  @apply flex justify-center items-center fixed z-30 text-black transform-none
  width: 2.25rem
  height: 2.25rem
  bottom: 4.75rem
  right: .375rem

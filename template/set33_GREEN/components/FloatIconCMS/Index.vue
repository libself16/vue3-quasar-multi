<template>
  <div v-if="floatingIconList?.length > 0" class="float-wrapper custom-float-wrapper01">
    ...
    <div @click="toggleShow" class="icon-container">
      <q-img
        v-if="!isLoading"
        :src="isShow ? floatCmsCloseIconGreen : floatIconPath"
...
const { floatCmsOpenIconGreen, floatCmsCloseIconGreen } = useSiteImg()
...
const floatIconPath = computed(() => {
  ...
  return matched && matched.storage_key ? matched.storage_key : floatCmsOpenIconGreen
})

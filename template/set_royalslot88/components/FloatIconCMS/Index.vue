<template>
  <div v-if="floatingIconList?.length > 0" class="float-wrapper">
    ...
    <div @click="toggleShow" class="icon-container">
      <q-img
        v-if="!isLoading"
        :src="isShow ? floatCmsCloseIconBlue03 : floatIconPath"
...
const { floatCmsOpenIconBlue03, floatCmsCloseIconBlue03 } = useSiteImg()
...
const floatIconPath = computed(() => {
  ...
  return matched && matched.storage_key ? matched.storage_key : floatCmsOpenIconBlue03
})
onMounted(() => {

  ...
  <div class="w-full px-6 phone:px-4">
    <div class="provider-container" :class="`${isMobile ? 'h5' : 'pc'}`">
      ...
      <swiper :slides-per-view="isMobile ? 2.5 : 4.3" :space-between="10">
        ...
        >
          <img
            :src="getProductTabImage({ ...product, siteKey: 'okbet_red' })"
            class="tab-img"
...
@import "app/template/okbet_red/assets/css/game.scss";
@import "app/template/okbet_red/assets/css/button.scss";
@import "app/template/okbet_red/assets/css/data.scss";
  ...
  &.h5 {
    ...
    .search-container {
      ...
      .tabs {
        ...
        .btn-tag {
          @apply py-1 px-0 ml-0;
          @apply text-sm pixel7:text-xs;
          @apply not-italic font-normal whitespace-nowrap  normal-case rounded-lg;

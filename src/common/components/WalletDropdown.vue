<template>
  <q-btn flat :ripple="false" class="no-ripple">
    <span v-if="inUseWallet" class="bln-balance normal-case font-bold text-yellow">
...
const { activeWalletLabel, activeWalletCurrencyCode, inUseWallet, userWalletMap, getWalletLabel, setUserActiveWallet } =
  useUserInfo()
</script>

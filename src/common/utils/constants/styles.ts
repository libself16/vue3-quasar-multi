...
export const PAGE_X_SPACING = "px-6 phone:px-4";

export const OVERFLOW_X_AUTO_HIDDEN = "overflow-x-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]";
